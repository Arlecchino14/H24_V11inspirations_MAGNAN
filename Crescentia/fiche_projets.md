...
Pour ce projet, les étudiants ont opté littéralement pour la croissance. Dans leur oeuvre, le public intéragit avec divers éléments afin de faire croître un arbre. D'abord, on plante la graine, ensuite on l'arrose, on l'illumine avec le soleil, on fait grandir l'arbre et finalement on cueuille une pomme.

<img src=".//media/crescentia_effet-papillon_croquis.png" width="300"/>
<h6>Croquis du projet provenant du Git Hub de l'équipe</h6>

<img src=".//media/crescentia_effet-papillon_avant.jpg" width="300"/>
<h6>La projection n'a pas enncore été complétée</h6>

<img src=".//media/crescentia_effet-papillon_lumiere.jpg" width="300"/>
<h6>Dispositf représentant le soleil</h6>
...
>Un jeu interactif oû le joueur doit éviter des obstacles dans un univers inspiré du style visuel néon rétro, dans lequel l'esthétique changera pour s'associer aux quatres saisons.> <h6>Le résumé provient du site web Tim : https://tim-montmorency.com/2024/projets/Kigo/docs/web/index.html</h6>

Kigo est un *endless runner game* (jeu de coureurs sans fin) interactif. À l'aide d'une kinect, les mouvements du joueurs sont transférés dans un environnement ludique qui défile et qui se développe plus le temps passe.
...
Dans ce projet, le public est entouré par des murs. Au centre, ce trouve une borne avec divers boutons et des écouteurs. En intéragissant avec la borne, la projection et la bande sonore sont impactées et changent.
